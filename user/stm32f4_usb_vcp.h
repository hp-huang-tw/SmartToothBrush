...
typedef enum {
	USB_VCP_OK,
	USB_VCP_ERROR,
	USB_VCP_RECEIVE_BUFFER_FULL,
	USB_VCP_DATA_OK,
	USB_VCP_DATA_EMPTY,
	USB_VCP_NOT_CONNECTED,
	USB_VCP_CONNECTED,
	USB_VCP_DEVICE_SUSPENDED,
	USB_VCP_DEVICE_RESUMED
} USB_VCP_Result;

/**
 * Initialize USB VCP
 *
 * USB_VCP_OK is returned
 */
extern USB_VCP_Result USB_VCP_Init(void);
 ...
 *
 * USB_VCP_DATA_OK is returned if data are valid, otherwise USB_VCP_DATA_EMPTY
 */
extern USB_VCP_Result USB_VCP_Getc(uint8_t* c);
 ...
 * USB_VCP_OK is returned
 */
extern USB_VCP_Result USB_VCP_Putc(volatile char c);
 ...
 * USB_VCP_DATA_OK is returned if data are valid, otherwise USB_VCP_DATA_EMPTY
 */
extern USB_VCP_Result USB_VCP_Gets(char* buffer, uint8_t bufsize);
 ...
 * USB_VCP_OK is returned
 */
extern USB_VCP_Result USB_VCP_Puts(char* str);

/**
 * Get VCP status
 *
 * Returns USB_VCP_CONNECTED if device is configured and drivers are OK on computer
 */
extern USB_VCP_Result USB_VCP_GetStatus(void);
